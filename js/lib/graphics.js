 ...
 * @param {string} [drawColor="black"] - Color of rectangle
 */
function colorRect(leftX,topY, width,height, drawColor = "black") {
 ...
 */
function colorRectCentered(centerX,centerY, width,height, drawColor="black") {
